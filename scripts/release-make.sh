...
AMP_PATH=`pwd`
RELEASES_PATH=${AMP_PATH}/ignored/releases
MAVEN_REPO_PATH=${AMP_PATH}/ignored/maven-repo
# FIXME: Make this relative!
CV=/Users/martin/repos/apache/incubator-brooklyn/usage/scripts/change-version.sh
REVISIONS=${AMP_PATH}/vcloud-director-nat-microservice/src/main/assembly/conf/revisions.txt
